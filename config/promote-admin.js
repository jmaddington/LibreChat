...
// Import helpers and initialize console color methods
require('./helpers'); 
...
(async () => {
  ...
  if (process.argv.length >= 3) {
    ...
    console.orange('Usage: npm run promote-admin <email>');
    console.orange('Note: if you do not pass in the email argument, you will be prompted for it.');
    console.purple('--------------------------');
  }
